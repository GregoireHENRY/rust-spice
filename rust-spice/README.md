...
functions are implemented yet: 190 of the 649 routines CSPICE exposes are
...
quaternions, two-body orbits, two-line elements, the kernel pool and error
handling. The events kernel (`ek*`)
